...
const Quiz = () => {
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900  px-5">
        ...
        <div className="flex justify-evenly items-center">
          ...
          <div className="flex flex-col bg-slate-800 rounded-lg shadow-lg p-6">
            ...
            <div className="mx-auto max-w-md pt-6">
              <button
                type="submit"
                className="w-full text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 transition duration-300"
              >
      ...
      <div className="text-xl p-10 text-white">
        Tip: Use{" "}
        <code className="bg-gray-500 rounded-lg p-2 text-base">tab</code> key to
        move forward in horizontal direction quickly. If you want to move
        backwards, horizontally, use{" "}
        <code className="bg-gray-500 rounded-lg p-2 text-base">
          shift + tab
        </code>{" "}
        key.
      </div>
